        ...
        if ($("div.sec-3").is(":visible")) {
          ...
          if (counter_circle_1 == 0) {
            ...
            $(".text2")
              ...
              .fadeIn("slow");
            if (isIOS()) {
              $("video.myvideo2").attr("src", "images/mercuryoutputnew.mov").animate(
            ...
            if (isIOS()){
              $("video.myvideo2").attr("src", "images/venusoutputnew.mov").animate(
                { left: "0px", top: "472px", width: "340px", display: "block" },
                {
                  duration: 1000,
                  queue: false,
            ...
            if (isIOS()) {
              $("video.myvideo2").attr("src", "images/earthouputnew.mov").animate(
                { left: "0px", top: "472px", width: "340px", display: "block" },
                {
                  duration: 1000,
                  queue: false,
            ...
            if (isIOS()) {
              $("video.myvideo2").attr("src", "images/marsoutputnew.mov").animate(
                { left: "0px", top: "472px", width: "340px", display: "block" },
                {
                  duration: 1000,
                  queue: false,
            ...
            $(".text2")
              ...
              .fadeIn("slow");
            if (isIOS()) {
              $("video.myvideo2").attr("src", "images/jupiteroutputnew.mov").animate(
                { left: "0px", top: "472px", width: "340px", display: "block" },
                {
                  duration: 1000,
                  queue: false,
            ...
            $(".text2")
              ...
              .fadeIn("slow");
            if(isIOS()) {
              $("video.myvideo2").attr("src", "images/saturnoutputnew.mov").animate(
            ...
            if (isIOS()){
              $("video.myvideo2").attr("src", "images/uranusoutputnew.mov").animate(
                { left: "0px", top: "472px", width: "340px", display: "block" },
                {
                  duration: 1000,
                  queue: false,
            ...
            $(".text2")
              ...
              .fadeIn();
            if(isIOS()){
              $("video.myvideo2").attr("src", "images/neptuneoutputnew.mov").animate(
                { left: "0px", top: "472px", width: "340px", display: "block" },
                {
                  duration: 1000,
                  queue: false,
